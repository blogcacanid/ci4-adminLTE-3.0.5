    ...
    <div class="sidebar">
        ...
        <div class="text-center">
            <a href="https://www.cacan.id"
                target="_blank" title="Personal Web"class="btn">
                <i class="fas fa-globe"></i>
            </a>
            <a href="https://twitter.com/KudusRony"
                target="_blank" title="Twitter" class="btn">
                <i class="fab fa-twitter"></i>
            </a>
            <a href="https://www.facebook.com/rony.chandrakudus"
                target="_blank" title="Facebook"  class="btn">
                <i class="fab fa-facebook"></i>
            </a>
            <a href="https://github.com/blogcacanid"
                target="_blank" title="Github" class="btn">
                <i class="fab fa-github"></i>
            </a>
            <a href="https://www.linkedin.com/in/rony-chandra-77027b185"
                target="_blank" title="LinkedIn" class="btn">
        ...
        <nav class="mt-2" style="font-size:14px">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url($request->uri->getSegment(1));?>" class="nav-link
                        <?php 
